    ...
    private String buildSeatRows(List<BookingEmailData.TicketRow> tickets) {
        ...
        for (int i = 0; i < tickets.size(); i++) {
            ...
            sb.append("<tr style='background:").append(bg).append(";'>")
              .append("<td style='padding:10px;border:1px solid #eee;color:#666;font-size:13px;'>").append(i + 1).append("</td>")
              .append("<td style='padding:10px;border:1px solid #eee;font-weight:bold;color:#333;'>").append(escapeHtml(row.seatCode())).append("</td>")
              .append("<td style='padding:10px;border:1px solid #eee;color:#555;font-family:monospace;'>").append(escapeHtml(row.ticketCode())).append("</td>")
              .append("<td style='padding:10px;border:1px solid #eee;text-align:right;color:#333;'>").append(formatVnd(row.price())).append("</td>")
              .append("</tr>");
        }
        return sb.toString();
    }
